...
for (y in 2007:2015) {
  ma.path=paste0("/Users/lisbethvargas/Library/Mobile Documents/com~apple~CloudDocs/Desktop/GitHub/Homework-4/4-1/data/input/monthly-ma-and-pdp-enrollment-by-cpsc/CPSC_Contract_Info_",y,"_01.csv")
  ...
  ma.path=paste0("/Users/lisbethvargas/Library/Mobile Documents/com~apple~CloudDocs/Desktop/GitHub/Homework-4/4-1/data/input/monthly-ma-and-pdp-enrollment-by-cpsc/CPSC_Enrollment_Info_",y,"_01.csv")
  ...
  write_rds(plan.year,paste0("/Users/lisbethvargas/Library/Mobile Documents/com~apple~CloudDocs/Desktop/GitHub/Homework-4/4-1/data/output/ma_data_",y,".rds"))}

full.ma.data <- read_rds("/Users/lisbethvargas/Library/Mobile Documents/com~apple~CloudDocs/Desktop/GitHub/Homework-4/4-1/data/output/ma_data_2007.rds")
for (y in 2008:2015) {
  full.ma.data <- rbind(full.ma.data,read_rds(paste0("/Users/lisbethvargas/Library/Mobile Documents/com~apple~CloudDocs/Desktop/GitHub/Homework-4/4-1/data/output/ma_data_",y,".rds")))}
